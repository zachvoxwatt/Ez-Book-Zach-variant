class Book {
  ...
  static List<Book> generateHeaderList() {
    return [
      Book(
          id: "1",
...
"""),
  ...
  static List<Book> generateCategoryList() {
    return [
      Book(
          id: "1",
          name: "Asar Morakab",
...
"""),
  ...
  static List<Book> generateItemsList() {
    return [
      Book(
          id: "1",
          name: "Asar Morakab",
...
"""),
  ...
  factory Book.fromJson(Map<String, dynamic> parsedJson) {
    return Book(
        id: parsedJson['objectId'],
        imgUrl: parsedJson['imgUrl'],
        name: parsedJson['name'],
        auther: parsedJson['auther'],
        score: parsedJson['score'],
        review: parsedJson['review'],
        view: parsedJson['view'],
        type: parsedJson['type'] as List,
        desc: parsedJson['desc'],
        content: parsedJson['content']);
  }
}

class BookError extends Book {
  final bool isError;
  BookError({required this.isError});
}
